...
var headFour = document.querySelectorAll('h4');
for (let i = 0; i < headFour.length; i++){
    headFour[i].setAttribute('style', 'color: blue; font-size: 30px; font-weight: bold; padding-left: 10px; margin: 0;');
}